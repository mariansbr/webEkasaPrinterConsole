...
type
  ...
  private
    ...
    FStart, FEnd: Integer;
    Full: Boolean;
    function GetStartPtr: PAnsiChar;
    function GetStartBufPtr: PAnsiChar;
  ...
  public
    ...
    function PeekChar(Index: Integer; var C: AnsiChar): Boolean;
    function Read(var Buf; Len: Integer): Boolean;
    function Remove(Len: Integer): Boolean;
    function Write(const Buf; Len: Integer): Boolean;
    property StartPtr: PAnsiChar read GetStartPtr;
    property StartBufPtr: PAnsiChar read GetStartBufPtr;
  end;
...
function TAfCircularBuffer.GetStartPtr: PAnsiChar;
begin
  Result := @FData[FStart];
end;

function TAfCircularBuffer.GetStartBufPtr: PAnsiChar;
begin
  Result := @FData;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Move(FData[0], PAnsiChar(@Buf)[SizeToEnd], Len - SizeToEnd);
      end;
    end;
    Result := True;
  end;
...
function TAfCircularBuffer.PeekChar(Index: Integer; var C: AnsiChar): Boolean;
var
  I: Integer;
begin
  Result := False;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Move(PAnsiChar(@Buf)[SizeToEnd], FData[0], Len - SizeToEnd);
      end;
    end else
      Move(Buf, FData[FEnd], Len);
    IncPtr(FEnd, Len);

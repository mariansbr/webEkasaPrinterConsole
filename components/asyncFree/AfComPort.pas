...
function TAfCustomSerialPort.ReadChar: AnsiChar;
begin
...
function TAfCustomSerialPort.ReadString: AnsiString;
var
  Size: Integer;
begin
  if FClosing then
...
procedure TAfCustomSerialPort.SetXOffChar(const Value: AnsiChar);
begin
...
procedure TAfCustomSerialPort.SetXOnChar(const Value: AnsiChar);
begin
...
procedure TAfCustomSerialPort.WriteChar(C: AnsiChar);
begin
  WriteData(C, 1);
end;
...
procedure TAfCustomSerialPort.WriteString(const S: AnsiString);
begin

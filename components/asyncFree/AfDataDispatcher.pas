...
function TAfCustomDataDispatcher.ReadChar: AnsiChar;
begin
  ReadData(Result, 1);
end;
...
function TAfCustomDataDispatcher.ReadString: AnsiString;
var
  Size: Integer;
begin
...
procedure TAfCustomDataDispatcher.WriteChar(C: AnsiChar);
begin
  WriteData(C, 1);
end;
...
procedure TAfCustomDataDispatcher.WriteString(const S: AnsiString);
begin
